<?php
    ...
    $showSidebar     = get_sub_field('all_blogs_section_show_sidebar');
    $showRecentPosts = get_sub_field('all_blogs_section_show_recent_posts');
    $posts           = get_sub_field('all_blogs_section_select_posts_to_show');
    $showCategories  = get_sub_field('all_blogs_section_show_categories');
    $showTags        = get_sub_field('all_blogs_section_show_tags');
    $showArchives    = get_sub_field('all_blogs_section_show_archives');
    $noOfPosts       = get_sub_field('all_blogs_section_show_on_each_page');
?>
            ...
            <?php if($showSidebar == 'yes') { ?>
                <div class="col-lg-4">
                    ...
                    <div class="widget recent-posts">
                        <h3 class="widget-title"><?php echo get_sub_field('all_blogs_section_recent_posts_title'); ?></h3>
                        
                        <?php if($showRecentPosts == 'yes'){
                            $args = array(
                                'post_type' => 'post',
                                'posts_per_page' => 3
                            );
                    ...
                    ?>
                    <?php if($categories && $showCategories == 'yes') { ?>
                        <div class="widget">
